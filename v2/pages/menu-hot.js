...
<!-- Hot Coffee Section -->
            <div class="menu-section" id="hot">
                <div class="menu-item" data-id="1">
                    <img src="/v2/images/espresso.jpg" alt="Espresso">
                ...
                <div class="menu-item" data-id="2">
                    <img src="/v2/images/americano.jpg" alt="Americano">
                    <div class="item-details">
                        <h3>Americano</h3>
                        <p>$3.49</p>
                    </div>
                ...
                <div class="menu-item" data-id="3">
                    <img src="/v2/images/latte.jpg" alt="Latte">
                    <div class="item-details">
                        <h3>Latte</h3>
                        <p>$4.29</p>
                    </div>
                ...
                <div class="menu-item" data-id="4">
                    <img src="/v2/images/cappuccino.jpg" alt="Cappuccino">
                    <div class="item-details">
                        <h3>Cappuccino</h3>
                        <p>$4.29</p>
                    </div>
